...
#ifndef QFB_GROUPBOOKMARKLISTMODEL_H
#define QFB_GROUPBOOKMARKLISTMODEL_H

/**
 * @file groupbookmarklistmodel.h
 * @brief Definition of QFB::GroupBookmarkListModel
 */
...
class QueryManager;
class GroupBookmarkListModelPrivate;

/**
 * @short WRITE DOCUMENTATION HERE
 */
class QFBBASEIMPORT_EXPORT GroupBookmarkListModel: public AbstractLoadableModel
{
    Q_OBJECT
public:
    /**
     * @short Model roles
     */
    enum GroupBookmarkListModelRole {
        /**
        * @short Data role
        */
     ...
     */
    explicit GroupBookmarkListModel(QObject *parent = 0);
    /**
...
private:
    Q_DECLARE_PRIVATE(GroupBookmarkListModel)
};

}

#endif // GROUPBOOKMARKLISTMODEL_H
